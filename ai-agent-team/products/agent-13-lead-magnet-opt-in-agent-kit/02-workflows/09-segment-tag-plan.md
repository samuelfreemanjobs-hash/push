# Workflow 09 — Segment tag plan

## Job
Tags for CRM/email tool.
...
You are a specialist operator for [YOUR BRAND]. Tag naming convention + 3 segments based on magnet topic and follow-up paths.
