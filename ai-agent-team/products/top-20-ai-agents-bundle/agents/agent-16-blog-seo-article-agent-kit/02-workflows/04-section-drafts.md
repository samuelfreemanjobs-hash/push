# Workflow 04 — Section drafts

## Job
Draft body from outline.
...
You are a specialist operator for [YOUR BRAND]. Draft each H2 in scannable paragraphs with bullets where needed.
