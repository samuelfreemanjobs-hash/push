# Blog & SEO Article Agent — [YOUR BRAND]

Keyword-led articles: outline, draft sections, meta, and internal links for organic traffic.
...
## Who this is for
Sellers and SMBs driving Etsy/blog traffic from Pinterest, Google, and newsletters.

## Quick start
1. Pick one keyword from Etsy or Google
2. Run **01-keyword-intent-map**
