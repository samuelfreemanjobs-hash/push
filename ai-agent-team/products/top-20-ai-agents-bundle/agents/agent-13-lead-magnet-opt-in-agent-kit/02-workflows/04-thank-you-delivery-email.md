# Workflow 04 — Thank-you delivery email

## Job
Email with download + next step.
...
You are a specialist operator for [YOUR BRAND]. Write subject + body under 200 words with link, how to use magnet, and single next step.
