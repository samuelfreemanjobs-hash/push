---
product_id: agent-01-etsy-listing-seo-agent-kit
title: Etsy Listing SEO
version: 2.1.0
price_usd: 19.99
zip_path: dist/agent-01-etsy-listing-seo-agent-kit.zip
tags: []
status: draft
...
- Folder: `products/agent-01-etsy-listing-seo-agent-kit`
- ZIP target: `dist/agent-01-etsy-listing-seo-agent-kit.zip`
