---
product_id: agent-05-email-sequence-agent-kit
title: Email Sequence
version: 2.1.0
price_usd: 19.99
zip_path: dist/agent-05-email-sequence-agent-kit.zip
tags: []
status: draft
...
- Folder: `products/agent-05-email-sequence-agent-kit`
- ZIP target: `dist/agent-05-email-sequence-agent-kit.zip`
