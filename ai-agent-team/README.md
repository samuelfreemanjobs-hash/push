...
Shop config: `config/etsy-store.yaml`. Listings: [ETSY-LAUNCH-PACK.md](docs/ETSY-LAUNCH-PACK.md). SEO titles/tags: [ETSY-KEYWORD-PASS.md](docs/ETSY-KEYWORD-PASS.md).
